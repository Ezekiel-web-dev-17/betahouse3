...
const ExquisiteHaven = () => {
  ...
  return (
    <div className="mt-5 pt-5">
      ...
      >
        {exquisiteHavenProperties.map((exquisiteHavenProperty, i) => (
          <div
            key={i}
          ...
          >
            ...
            >
              <div className="more position-relative">
                ...
                <div>
                  ...
                  <span className="for rounded-2 text-white position-absolute w-100">
                    For {exquisiteHavenProperty.whatFor}
                  </span>
                </div>
              ...
              <div
                ...
                style={{ minWidth: "101%" }}
              >
                <h4 className=" mb-0">{exquisiteHavenProperty.title}</h4>
                <p
                  className="mb-sm-3 mb-1"
                  style={{ color: "#666666", font: "Outfit" }}
                >
                  {<BsFillGeoAltFill />} {exquisiteHavenProperty.location}
                </p>
                <div
                ...
                >
                  <span className="d-flex justify-content-between gap-2 me-sm-0 me-4">
                    ...
                    <p className="mb-0 abt">
                      {exquisiteHavenProperty.bed} Bedrooms
                    </p>
                  </span>
                  <span className="d-flex justify-content-between gap-2 me-5">
                    <img src={bathroom} alt="" />
                    <p className="mb-0 abt">
                      {exquisiteHavenProperty.bath} Bathrooms
                    </p>
                  </span>
                </div>
                ...
                <div className=" w-100 d-flex justify-content-between align-items-center border-top border-dark-subtle border-1 mt-3 pt-4">
                  <h4 className="mb-0">
                    ₦ {exquisiteHavenProperty.price}
                    {exquisiteHavenProperty.whatFor === "Rent" ? "/yr" : ""}
                  </h4>
